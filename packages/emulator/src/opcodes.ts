...
// Named exports so other modules in this package can import exactly what they need
export {
  MOV_RM_RM, MOV_IMMEDIATE_TO_RM, MOV_IMMEDIATE_TO_R, MOV_ACCUMULATOR_MEMORY, MOV_RM_SEGEMENT,
  AND_RM_RM, AND_IMMEDIATE_TO_R, AND_IMMEDIATE_TO_ACC,
  OR_RM_RM, OR_IMMEDIATE_TO_R, OR_IMMEDIATE_TO_ACC,
  XOR_RM_RM, XOR_IMMEDIATE_TO_R, XOR_IMMEDIATE_TO_ACC,
  TEST_RM_RM, TEST_IMMEDIATE_TO_R, TEST_IMMEDIATE_TO_ACC,
  REP_INS, MOVS_INS, LODS_INS, STOS_INS, CMPS_INS, SCAS_INS,
  MUL, DIV, INT, PUSH_REG_MEM, POP_REG_MEM, RET_SEG, RET_INTERSEG,
  NOT, SHR, SAR, ROL, ROR, RCL, RCR, SHL_SAL, UNC_JUMP, CON_JMP,
  LOOP, LOOPE, LOOPNE,
  ADD_REG_MEM, ADC_REG_MEM, ARITHMETIC_IMM, ADD_ACC_IMM, ADC_ACC_IMM,
  SUB_REG_MEM, SBB_REG_MEM, SUB_ACC_IMM, SBB_ACC_IMM, CBW, CWD,
  INC_REG, INC_REG_MEM, DEC_REG_MEM, JMP_SEG, JMP_SEG_SHORT, JMP_IND_SEG,
  JMP_DIR_INTSEG, CALL_DIR_SEG, CALL_DIR_INTSEG, SEG_OVER_PREF,
  HIGH_REGISTER, LOW_REGISTER,
  ...
  JE, JL, JLE, JB, JBE, JP, JO, JS, JNE, JNL, JNLE, JNB, JNBE, JNP, JNO, JNS,
};
